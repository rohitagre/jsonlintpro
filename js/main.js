...
/*! jQuery v1.9.0 | (c) 2005, 2012 jQuery Foundation, Inc. | jquery.org/license */(function (e, t) {
    ...
    st.event = {global: {}, add: function (e, n, r, i, o) {
            ...
            if (y) {
                for (r.handler && (a = r, r = a.handler, o = a.selector), r.guid || (r.guid = st.guid++), (l = y.events) || (l = y.events = {}), (s = y.handle) || (s = y.handle = function(e){return st === t || e && st.event.triggered === e.type?t:st.event.dispatch.apply(s.elem, arguments)}, s.elem = e), n = (n || "").match(lt) || [""], c = n.length; c--; )
...
(function () {
    ...
    var s = /\s+/, n = function (a, b, c, d) {
                ...
                if (a = g[i], d = this._events[a]) {
                    ...
                    if (b ||
                        ...
                        for (j = d.length; h < j; h++)
                            f = d[h], (b && b !== (f.callback._callback || f.callback) || c && c !== f.context) && l.push(f)
                    }
                    this._events[a] = l
                }
            return this
        ...
        stopListening: function (a, b, c) {
            ...
            if (d) {
                if (a)
                    a.off(b, c, this), !b && !c && delete d[a._listenerId];
                else {
                    for (var f in d)
    ...
    e.extend(o.prototype, h, {changed: null, idAttribute: "id", initialize: function () {}, toJSON: function () {
            ...
            if (d && !this.set(d, c.wait ? a : c) || !d && !this._validate(null, c))
                return!1;
            ...
            if (!a)
                return this.hasChanged() ? e.clone(this.changed) : !1;
            var b, c = !1, d = this._previousAttributes, f;
            for (f in a)
                if (!e.isEqual(d[f], b = a[f]))
                    (c || (c = {}))[f] = b;
            return c
    ...
    e.extend(p.prototype, h, {model: o, initialize: function () {}, toJSON: function (a) {
            ...
            for (c = a.length - 1; 0 <= c; c--)
                (d = this._prepareModel(a[c], b)) ? (a[c] = d, (f = null != d.id && this._byId[d.id]) || this._byCid[d.cid] ? (b && (b.merge && f) && (f.set(d.attributes, b), g = i), a.splice(c, 1)) : (d.on("all", this._onModelEvent, this), this._byCid[d.cid] = d, null != d.id && (this._byId[d.id] = d))) : (this.trigger("error", this, a[c], b), a.splice(c, 1));
            a.length && (g = i);
        ...
        sort: function (a) {
            ...
            for (f = a.length; d < f; d++)
                c = a[d], g = this.get(c.id || c.cid || c[j]), b.remove && g && (m[g.cid] = !0), (b.add && !g || b.merge && g) && h.push(c);
            if (b.remove) {
                d = 0;
        ...
        loadUrl: function (a) {
            ...
            if (this.fragment !== a) {
                ...
                if (this._hasPushState)
                    ...
                    this._updateHash(this.location, a, b.replace), this.iframe && a !== this.getFragment(this.getHash(this.iframe)) &&
    ...
    g.sync = function (a, b, c) {
        ...
        if (null == c.data && b && ("create" ===
                a || "update" === a || "patch" === a))
            f.contentType = "application/json", f.data = JSON.stringify(c.attrs || b.toJSON(c));
...
var jsonCompositeTemplate = '<div id="json-composite"><div id="validator-placeholder1"></div><div id="validator-placeholder2"></div><div id="diff-placeholder"></div><a href="#" title="Tips and Tricks" id="help"><span class="icon">Tips and Tricks</span></a><div id="tips-and-tricks"><a id="close-tips" class="close-btn" href="#">X</a><h1>JSON Lint Pro</h1><h2>The easiest way to validate and format JSON</h2><ul><li>Type your JSON into the textarea, or enter a remote URL</li><li>Use the split mode to speed up your workflow, or to run a diff.</li><li>Use the delete button to quickly clear your input.</li></ul><p>A project from the <a target="_blank" href="http://lab.arc90.com">Arc90 Lab</a>. Check out the source on <a target="_blank" href="https://github.com/arc90/jsonlintpro">GitHub</a>. Props to <a target="_blank" href="http://www.crockford.com/">Douglas Crockford</a> of <a target="_blank" href="http://www.json.org">JSON</a> and <a target="_blank" href="http://www.jslint.com">JS Lint</a>, and <a target="_blank" href="http://zaa.ch/">Zach Carter</a>, who provided the <a target="_blank" href="https://github.com/zaach/jsonlint"> JS implementation of JSONlint</a>.</p></div></div>',
